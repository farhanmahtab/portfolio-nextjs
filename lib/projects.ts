...
export const PROJECTS: Project[] = [
  {
    ...
    longDesc:
      "A comprehensive business management platform designed for efficiency and scalability. It features a robust backend built with Ruby on Rails and a modern, responsive frontend using Next.js and TailwindCSS.",
    techStack: [
      "Ruby on Rails",
      "Next.js",
      "TailwindCSS",
  ...
  },
  {
    ...
    longDesc:
      "A specialized platform for managing traditional services and logistics. Built with the MERN stack, it leverages AWS for reliable hosting and SSLCommerce for secure transactions.",
  ...
  },
  {
    id: "mapage-ec",
    title: "Mapage EC",
    shortDesc: "NextJS, React, NodeJS, Express , AWS and MongoDB",
    longDesc:
      "An e-commerce solution providing a seamless shopping experience. It focuses on performance and user engagement with a modern tech stack.",
    techStack: [
      "Next.js",
      "React",
      "NodeJS",
  ...
  },
  {
    ...
    shortDesc: "NextJS, React, NodeJS, Express , AWS and MongoDB",
    longDesc:
      "A user-centric portal for the Mapage ecosystem, allowing users to manage their profiles, orders, booking and preferences.",
    techStack: [
      "Next.js",
      "React",
      "NodeJS",
    ...
    features: [
      "User and Stylist profile management",
      "Service booking and order tracking",
      "SEO-friendly server-side rendering with Next.js",
    ],
    isLive: true,
  },
  {
    ...
    shortDesc: "NextJS, React, NodeJS, Express, AWS and MongoDB",
    longDesc:
      "A sophisticated tool for managing physical and digital spaces within the Mapage network.",
    techStack: [
      "Next.js",
      "React",
      "NodeJS",
  ...
  },
  {
    ...
    longDesc:
      "The official website for the Institute of Information and Communication Technology (IICT) at SUST. It features dynamic content management and a modern UI.",
